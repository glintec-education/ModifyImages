#3  programas:
   #    1.- Captura de conjunto de imagenes desde la camara a ser calibrada (main.cpp)
   #    2.- Realizar la calibracion de la camara usando el conjunto de imagenes antes adquiridos (calcamera.cpp)
   #    3.- Valida los datos adquiridos de los pasos previos (medicion.cpp)
