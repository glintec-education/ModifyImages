...
int main(){
    ...
    cv::Size patternsize = cv::Size(8,6);//esquinas interiores del tablero de ajedrez
...
//    std::string direccion = "C:\\Users\\NilssenSteban\\Pictures\\Saved Pictures\\Cam";
    std::string direccion = "/home/glintec/Documents/recovery/CameraCal/microCam800x600_";
    ...
    double rms = calibrateCamera(coord3D, coord2D, img.size(), cameraMatrix,
                  distCoeffs, rvecs, tvecs,
                                    ...
                                    ,TermCriteria(TermCriteria::COUNT + TermCriteria::EPS, 30, 2.22e-16));
...
//                rvecs,tvecs,rms);
    ...
    saveparams("/home/glintec/Documents/recovery/CameraCal/DataCamMicro800x600.yml",cameraMatrix,distCoeffs,
                rvecs,tvecs,rms);
